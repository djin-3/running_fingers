...
- [ ] 効果音・BGM
  - [ ] タップ音・スタート音・ゴール音・ベスト更新音
  - [ ] BGMループ再生（ホーム画面ヘッダーにオン/オフアイコン）
- [ ] SNS共有
  - [ ] リザルト画面をスクリーンショット画像としてシェア
- [x] モバイル最適化
  - [x] 画面スリープ防止（プレイ中）
...
次にやること（Phase 4 残り）:
1. 効果音・BGM（タップ音・スタート音・ゴール音・ベスト更新音・BGMループ＋オン/オフ設定）
2. SNS共有（リザルト画面のスクリーンショットをシェア）
3. 課金スキン対応（色テーマ差し替え構造）
